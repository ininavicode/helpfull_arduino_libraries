...
void loop() {
  static PhysicButton my_button(5, INPUT_PULLUP); //creating a button at the pin 5 with INPUT_PULLLUP = pinMode(5, INPUT_PULLUP)
  ...
  if (my_button.getTimeOn() > 2000) Serial.println("Pressed more than 2000 millisseconds");
  if (my_button.getTimeOff() > 2000) Serial.println("Unpressed more than 2000 millisseconds");
}
